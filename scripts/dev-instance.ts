...
export interface DevelopmentInstance {
  ...
  cloudRemotePort: number
  dataDirectory: string
  derivedDataPath: string
  developmentIconColor: WorktreeColor
  directRemoteName: string
  directRemotePort: number
...
export function sanitizeAmbientEnvironment(environment: NodeJS.ProcessEnv): void {
...
export async function resolveDevelopmentInstance(
  repoRoot: string,
...
export async function migrateLegacyDevelopmentState(
