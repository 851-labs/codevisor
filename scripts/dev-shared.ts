// Helpers shared by the development runners (scripts/dev.ts and
// scripts/dev-ios.ts): port scanning, health probing, process exit
...
export interface WorktreeColor {
  hex: string
  composer: string
}
...
export function colorFromHash(hash: string): WorktreeColor {
...
export function parsePort(value: string | undefined, name: string): number | undefined {
...
export async function containsAnyPath(root: string, names: readonly string[]): Promise<boolean> {
...
export function describeExit({ code, signal }: ExitResult): string {
