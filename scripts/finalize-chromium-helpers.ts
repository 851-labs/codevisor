...
/// for the final helper-signing phase that runs this file, so the contract is
/// declared once here instead of guarded at every read.
interface ChromiumHelperEnvironment extends NodeJS.ProcessEnv {
...
const env = process.env as ChromiumHelperEnvironment
