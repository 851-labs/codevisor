...
function run(command: string, args: readonly string[], capture: true): string
function run(command: string, args: readonly string[], capture?: false): undefined
function run(command: string, args: readonly string[], capture = false): string | undefined {
