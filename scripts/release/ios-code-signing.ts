...
export async function embeddedCodePaths(bundle: string): Promise<string[]> {
  const paths: string[] = []
...
export async function prepareEmbeddedCode(bundle: string, entitlementsPath: string): Promise<void> {
...
export async function verifyDistributionSignatures(bundle: string, teamId: string): Promise<void> {
