...
import { delay, describeExit, waitForExit, waitForHealth } from "./dev-shared.ts"
...
// `simulator` is resolved exactly when iOS is included, a few lines above.
...
const withoutCloudToken = (environment: NodeJS.ProcessEnv): NodeJS.ProcessEnv => {
...
async function announceDevRemote(): Promise<string> {
