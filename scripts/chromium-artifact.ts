...
/// A published CEF build: the upstream platform slug and the checksum of the
/// archive that slug resolves to.
...
async function digest(path: string, algorithm = "sha256"): Promise<string> {
...
export async function ensureChromium(
  ...
  architectures: readonly string[] = [process.arch === "arm64" ? "arm64" : "x86_64"]
): Promise<void> {
