...
// Short, ASCII surname slugs associated with confirmed-deceased STEM pioneers.
// Derived from Nobel science/economics laureates with recorded death dates and
// a curated historical supplement, then normalized, length-limited, and sorted.
export const generatedWorktreeNames = [
  "abrikosov",
  "adrian",
  "akasaki",
  "al-biruni",
...
/// Tries inexpensive random picks first, then scans the complete pool from a
/// random offset. A random ID is appended only when every base name is in use.
export const availableGeneratedWorktreeName = (
  ...
  throw new Error("Unable to allocate a unique generated worktree name")
}
