...
// HERDMAN-PATCH: removed toSplitTreeFocusDirection extension (upstream L219-246;
// depends on SplitTree from Sources/Features/Splits, which HerdMan does not vendor —
// split management actions are unhandled in the HerdMan embedder).
