import SwiftUI
import GhosttyKit
// HERDMAN-PATCH-BEGIN: explicit os + Combine imports for Logger interpolation and
...
extension Ghostty {
    ...
    class Config: ObservableObject {
        ...
        // HERDMAN-PATCH-BEGIN: use the non-AppKit Bool variant of windowFullscreen and
        // drop windowFullscreenMode (upstream L284-343; FullscreenMode lives in
        // Sources/Helpers/Fullscreen.swift which HerdMan does not vendor — fullscreen
        // toggle actions are unhandled in the HerdMan embedder)
...
#error("unsupported")
        ...
        // HERDMAN-PATCH: removed quickTerminal* accessors (upstream L555-609;
        // depend on QuickTerminalPosition/Screen/SpaceBehavior/Size types from
        // Sources/Features/QuickTerminal, which HerdMan does not vendor)
