// HERDMAN-PATCH-BEGIN (file-wide note): all `AppDelegate.logger` references were
// replaced with `Ghostty.logger` (14 sites; AppDelegate is not vendored). Larger
// patches are marked inline with HERDMAN-PATCH markers.
// HERDMAN-PATCH-END
import AppKit
import Combine
import SwiftUI
...
import GhosttyKit
// HERDMAN-PATCH-BEGIN: explicit os import for Logger under MemberImportVisibility
...
extension Ghostty {
    ...
    // HERDMAN-PATCH: dropped Codable conformance (window-restoration support;
    ...
    class SurfaceView: OSSurfaceView, Identifiable {
        ...
        init(_ app: ghostty_app_t, baseConfig: SurfaceConfiguration? = nil, uuid: UUID? = nil) {
            ...
            // HERDMAN-PATCH-BEGIN: app-wide config comes from HerdManGhosttyApp,
            // not AppDelegate (upstream L226-230)
            self.derivedConfig = DerivedConfig(HerdManGhosttyApp.shared.config)
            // HERDMAN-PATCH-END
        ...
        private func localEventLeftMouseDown(_ event: NSEvent) -> NSEvent? {
            // HERDMAN-PATCH: removed command-palette visibility guard (upstream
        ...
        override func mouseMoved(with event: NSEvent) {
            ...
            // HERDMAN-PATCH: removed focus-follows-mouse block (upstream L1007-1015;
            // requires BaseTerminalController which is not vendored — HerdMan does
        ...
        override func performKeyEquivalent(with event: NSEvent) -> Bool {
            ...
            if let bindingFlags {
                ...
                // HERDMAN-PATCH: removed the menu-item key-equivalent attempt
                // (upstream L1302-1310; AppDelegate.performGhosttyBindingMenuKeyEquivalent
                // is not vendored — HerdMan has no ghostty-managed menu). Bindings
        ...
        override func menu(for event: NSEvent) -> NSMenu? {
            ...
            // HERDMAN-PATCH-BEGIN: reduced context menu (upstream L1572-1593).
        ...
        // HERDMAN-PATCH: removed splitRight/Left/Down/Up @IBActions (upstream
        // L1681-1699; their context-menu items were removed — HerdMan does not
        ...
        // HERDMAN-PATCH: removed Codable support (upstream L1791-1833, MARK: Codable —
        // CodingKeys, init(from:), encode(to:)). Window-restoration decoding depends on
        // AppDelegate + TerminalRestoreError, neither vendored; HerdMan owns session
