...
enum Ghostty {
    ...
    // CODEVISOR-PATCH: nonisolated — logged from libghostty callbacks on any thread, and
    // Codevisor builds with SWIFT_DEFAULT_ACTOR_ISOLATION = MainActor. Logger is Sendable.
