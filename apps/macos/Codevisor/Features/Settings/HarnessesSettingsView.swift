...
/// Settings ▸ Machines ▸ Harnesses: toggle the installed ACP harnesses on
/// this machine, rescan for newly installed ones, and see which known
/// harnesses aren't installed yet.
