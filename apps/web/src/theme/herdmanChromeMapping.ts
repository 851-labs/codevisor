...
export const herdmanChromeMapping: ChromeMapping = (chrome, theme) => {
  ...
  style["--herdman-accent"] = chrome.accent
  style["--herdman-separator"] = chrome.separator
  ...
  style["--herdman-card-quiet-bg"] = style["--herdman-card-bg"]
  ...
  style["--herdman-code-bg"] = editorBg ?? chrome.background
