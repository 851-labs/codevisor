...
/// a message id. The destination is always the row keyed by `messageID`,
/// whether it is still optimistic or already settled: a send never waits on
/// the server to animate.
