...
final class ScreenSharingDecoderRecoveryCheck: @unchecked Sendable {
  ...
  func arm(afterFrames: Int, onReset: (@Sendable () -> Void)? = nil) {
  ...
  func inspect(keyFrame: Bool, nowNs: Int64) -> Action {
