...
public struct TranscriptPresentationRow: Identifiable, Equatable, Sendable {
  public enum ID: Hashable, Sendable {
    ...
    public var layoutKey: String {
      ...
      case .historyGap: "special:history-gap"
  ...
  public enum Content: Equatable, Sendable {
    ...
    case inlineText(TranscriptInlineTextPage)
...
public actor TranscriptRowProjectionCache {
  ...
  public static func project(
    ...
    if input.hasNewerHistory { rows.append(.init(id: .historyGap, content: .historyGap, estimatedHeight: 44)) }
