...
struct RigConfigurationTests {
  ...
  @Test(arguments: [
    ...
    "virtual:1920x1080@60", "virtual:2560x1440@30", "app:com.apple.dt.Xcode", "app:com.apple.finder", "window:4711",
  ])
  ...
  @Test(arguments: [
    ...
    "virtual:1920x1080", "virtual:1921x1080@60", "virtual:", "app:", "app:has space", "window:0", "window:x",
  ])
