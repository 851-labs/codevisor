...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| Screen Recording / Accessibility grants die on every rebuild because the probe is ad-hoc signed and TCC pins the code hash. 84 probe identities exist under `tmp/screen-sharing/`. | `scripts/screen-sharing-probe.mjs:109-110`, `packages/swift/ScreenSharing/README.md:113-128` |
